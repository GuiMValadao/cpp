/*Obtaining derived data from an object
Different approaches to obtaining data from an object:
-Adhoc : calculates the area when necessary
-Lazy : checks if side changed, calculates new value if it did, or return old area value if not
*/
